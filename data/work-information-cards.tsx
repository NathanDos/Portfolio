"use client";
export interface IWorkInformationCard {
    title: string;
    subtitle: string;
    badge: string;
    image: string;
...
export const WorkInformationCards = [
    {
    title: "Application Developer",
    subtitle: "Infostructure Technology Inc",
    badge: "React, C#, SQL, .NET, Azure",
  ...
  },
  {
    title: "Shift Manager",
    subtitle: "McDonald's",
    badge: "Management, Customer Service, Team Leadership",
